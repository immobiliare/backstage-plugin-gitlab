...
const MergeRequestsAssignedToReviewCard = () => {
  ...
  const { value, loading, error } = useAsync(async () => {
    const mergeRequests = await GitlabCIAPI.getMergeRequestsAssignedToMeAsReviewer();
  ...
  if (loading) {
    ...
    return (
      <InfoCard title="MR Review Requests">
        <Typography>No merge requests assigned to you for review.</Typography>
      </InfoCard>
    );
  }
...
export default MergeRequestsAssignedToReviewCard;
