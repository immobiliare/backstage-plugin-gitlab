...
- **Dependency synchronization:** This version "updates all deps" following the upgrade to **Backstage >= 1.48.0**.
- **New Frontend System Support:** Added support for the New Frontend System. This introduces new blueprints for components.
- **Component Renames/Moves:** All Material-UI (v4 and v5) dependencies have been synchronized. If you were using internal component imports, note that several exports have been moved or updated to align with the new system.
- **Manual Steps for Consumers:**
  1. Ensure your Backstage instance is updated to version **1.48.0** or higher.
  2. Update your `package.json` to use `@immobiliarelabs/backstage-plugin-gitlab^7.0.0-alpha.0`.
  3. If you previously imported components from internal paths, update them to use the main package or `@immobiliarelabs/backstage-plugin-gitlab/alpha` exports.
  4. Run a clean install (`rm -rf node_modules && yarn install`) and rebuild your application.

## [6.13.0](https://github.com/immobiliare/backstage-plugin-gitlab/compare/v6.13.0-alpha.0...v6.13.0) (2025-09-08)

**Note:** Version bump only for package @immobiliarelabs/backstage-plugin-gitlab

## [6.13.0-alpha.0](https://github.com/immobiliare/backstage-plugin-gitlab/compare/v6.12.1...v6.13.0-alpha.0) (2025-09-08)

### Features

- add support for the new frontend system ([1a268f7](https://github.com/immobiliare/backstage-plugin-gitlab/commit/1a268f723c2e332a800b95b6f332cbc46e383ce0))

### [6.12.1](https://github.com/immobiliare/backstage-plugin-gitlab/compare/v6.12.0...v6.12.1) (2025-07-07)

### Bug Fixes

- MergeRequestStats component full support i18n ([c780b2e](https://github.com/immobiliare/backstage-plugin-gitlab/commit/c780b2ea8f871ba429aec70dd79afe30ea6a29ef))
